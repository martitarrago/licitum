...
async def crear_certificado(
    *,
    ...
    titulo: Annotated[str, Form(min_length=1, max_length=512)],
    organismo: Annotated[str, Form(min_length=1, max_length=255)],
    importe_adjudicacion: Annotated[Decimal, Form(ge=0)],
    fecha_inicio: Annotated[date, Form()],
    fecha_fin: Annotated[date, Form()],
    numero_expediente: Annotated[str, Form(min_length=1, max_length=128)],
    cpv_codes: Annotated[
        str | None,
